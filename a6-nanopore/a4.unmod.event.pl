...
$outname=$ARGV[0];
$outname=~s/.combined.RDatamod_mat.tsv/.unmod.tsv/g;
print "perl a4.unmod.event.pl Tetra_NAI_N3_1.combined.RDatamod_mat.tsv Tetra_NAI_N3_1.combined.RData.tsv $outname\n";
