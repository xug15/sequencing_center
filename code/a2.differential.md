...
for i in ${name[@]}
do 
echo -e "htseq-count -q -f bam -s reverse $data_p/${i}_STAR/${i}Aligned.toTranscriptome.out.bam ${gtf} > ${i}.count";
done;
...
for i in ${name[@]}
do 
echo -e "python RPF_count_CDS.py  $data_p/${i}_STAR/${i}Aligned.toTranscriptome.out.bam ${gtf} > ${i}.count";
done;
